...
If you wanted to include code in your blog posts, it would look like this:
...
- Normal text: Sed do eiusmod tempor incididunt

### Numbered List

1. First item with lorem ipsum dolor sit amet
2. Second item with consectetur adipiscing elit
3. Third item with sed do eiusmod tempor incididunt
